...
TODAY = "2026-09-04"
TODAY_DISP = "2026년 9월 4일 (금)"

with open("/sessions/dazzling-upbeat-hypatia/mnt/outputs/parsed_disclosures.json", encoding="utf-8") as f:
    parsed = json.load(f)
with open("/sessions/dazzling-upbeat-hypatia/mnt/outputs/prices_all.json", encoding="utf-8") as f:
    prices = json.load(f)
with open("/sessions/dazzling-upbeat-hypatia/mnt/outputs/company_info.json", encoding="utf-8") as f:
    company_info = json.load(f)
with open("/sessions/dazzling-upbeat-hypatia/mnt/outputs/naver_finance.json", encoding="utf-8") as f:
    naver = json.load(f)

# 한글 큐레이션된 overrides (WebSearch + 사용자 지식 기반)
ENRICHED = {}
override_path = "/sessions/dazzling-upbeat-hypatia/mnt/outputs/enriched_overrides.json"
if os.path.exists(override_path):
    with open(override_path, encoding="utf-8") as f:
        ENRICHED = json.load(f)

# Aggregates (cumulative)
AGG_PATH = "/sessions/dazzling-upbeat-hypatia/mnt/outputs/daily_aggregates.json"
agg_data = {"by_date": {}}
...
DAILY_ANALYSES = {}
daily_path = f"/sessions/dazzling-upbeat-hypatia/mnt/outputs/daily_analyses_{TODAY}.json"
...
out_path = "/sessions/dazzling-upbeat-hypatia/mnt/outputs/AWAKE_v11.html"
